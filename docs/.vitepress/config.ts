      ...
      '/cli/': [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Code Search 命令 (/codesearch)',
              link: '/cli/24-code-search-command-codesearch',
            },
            { text: 'AI Credits 命令 (/credits)', link: '/cli/25-ai-credits-command-credits' },
            { text: 'Diff 命令 (/diff)', link: '/cli/26-diff-command-diff' },
            {
              text: 'Permissions 命令 (/permissions)',
              link: '/cli/27-permissions-command-permissions',
            },
            { text: 'Resume 命令 (/resume)', link: '/cli/28-resume-command-resume' },
            {
              text: 'Status Line 命令 (/statusline)',
              link: '/cli/29-status-line-command-statusline',
            },
